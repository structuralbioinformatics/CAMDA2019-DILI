...
# Output files
output.cv.rf <- sprintf("/home/quim/PHD/Projects/camda/results/crossvalidation/cv_signature_top%s_%s_correlated_rf.txt", num_top, corr_threshold)
output.cv.gbm <- sprintf("/home/quim/PHD/Projects/camda/results/crossvalidation/cv_signature_top%s_%s_correlated_gbm.txt", num_top, corr_threshold)
output.ind.rf = sprintf("/home/quim/PHD/Projects/camda/camda_data/independent_validation/JAguirre_predictions_signature_top%s_%s_correlated_rf.txt", num_top, corr_threshold)
output.ind.gbm = sprintf("/home/quim/PHD/Projects/camda/camda_data/independent_validation/JAguirre_predictions_signature_top%s_%s_correlated_gbm.txt", num_top, corr_threshold)
...
datasets.list <- prepare.balanced.datasets(expression_reverse_df, number.repetitions, drug.dataset$most_concern_drugs, drug.dataset$less_concern_drugs, drug.dataset$no_concern_drugs, type_analysis = "discrete", fraction_train=fraction_train)
...
signature.ind.rf <- validate.classifier(expression_reverse_ind_df, 
                                        output.ind.rf, 
...
signature.ind.gbm <- validate.classifier(expression_reverse_ind_df, 
                                         output.ind.gbm, 
